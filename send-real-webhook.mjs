...
async function sendWebhook() {
  ...
  console.log(`📊 Progress: ${payload.project.progress}%`)
  console.log(`💰 Value: ${payload.project.contract_value.toLocaleString('vi-VN')} VND`)
  console.log(`📍 Location: ${payload.project.address_full}`)
  console.log()
